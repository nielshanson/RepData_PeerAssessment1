...
legend(83.67, 744.41, c("Avg. Steps","Avg. Steps (imputed)"), lwd=c(3,3),col=c("red","black"))
```

Doesn't look to be that substantial a change.

## Are there differences in activity patterns between weekdays and weekends?

We'll separate the two day classes and calcualte the per step averages separately. Then we will plot them together with different colors.
